...
////////////////////////////////////////////////////////////
    ...
    private:
        template<class CC>
        typename std::enable_if<!std::is_const<CC>::value, size_t>::type
        WriteHelper(const void *ptr, size_t size, size_t num) {
            ...
            std::copy(reinterpret_cast<const unsigned char *>(ptr),
                      reinterpret_cast<const unsigned char *>(ptr) + size * num, container_.begin() + position_);
    ...
    public:
        ...
        virtual size_t Read(void *ptr, size_t size, size_t maxnum) override {
            ...
            std::copy(container_.begin() + position_, container_.begin() + position_ + toread,
