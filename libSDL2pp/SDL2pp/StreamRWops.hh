...
////////////////////////////////////////////////////////////
    ...
    class StreamRWops : public CustomRWops {
        ...
        static_assert(!(std::is_base_of<std::istream, S>::value && std::is_base_of<std::ostream, S>::value),
    ...
    private:
        ...
        typename std::enable_if<
                std::is_base_of<std::istream, SS>::value && !std::is_base_of<std::ostream, SS>::value, void>::type
        SeekHelper(typename SS::off_type off, std::ios_base::seekdir dir) {
        ...
        template<class SS>
        typename std::enable_if<std::is_base_of<std::istream, SS>::value &&
                                !std::is_base_of<std::ostream, SS>::value, typename SS::off_type>::type TellHelper() {
        ...
        template<class SS>
        typename std::enable_if<std::is_base_of<std::istream, SS>::value, size_t>::type
        ReadHelper(void *ptr, size_t size, size_t maxnum) {
        ...
        template<class SS>
        typename std::enable_if<!std::is_base_of<std::istream, SS>::value, size_t>::type
        ReadHelper(void *, size_t, size_t) {
            return 0;
        }

        template<class SS>
        typename std::enable_if<std::is_base_of<std::ostream, SS>::value, size_t>::type
        WriteHelper(const void *ptr, size_t size, size_t num) {
        ...
        template<class SS>
        typename std::enable_if<!std::is_base_of<std::ostream, SS>::value, size_t>::type
        WriteHelper(const void *, size_t, size_t) {
            return 0;
        }
