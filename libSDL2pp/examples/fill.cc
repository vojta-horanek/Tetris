...
static int Run() {
    ...
    Window window("libSDL2pp demo: fill", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 640, 480,
    ...
    Texture sprite(render, TESTDATA_DIR
    "/crate.png");
    ...
    while (1) {
        ...
        render.FillCopy(sprite, NullOpt, Rect(32, 32, window.GetWidth() - 64, window.GetHeight() - 64),
                        SDL2pp::Point((int) dx, (int) dy), SDL_FLIP_HORIZONTAL);
