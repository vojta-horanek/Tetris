...
int main(int, char *[]) try {
    ...
    Window window("libSDL2pp demo: loading", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 640, 480,
    ...
    Surface surf(TESTDATA_DIR
    "/test.png");

    Texture sprite1(render, TESTDATA_DIR
    "/test.png");
    ...
    while (1) {
        ...
        render.Copy(sprite1, NullOpt,
                    Rect(320 - 32 + (int) (std::sin(angle) * 40.0f), 240 - 32 + (int) (std::cos(angle) * 40.0f), 64,
                         64));
        render.Copy(sprite2, NullOpt,
                    Rect(320 - 32 - (int) (std::sin(angle) * 40.0f), 240 - 32 - (int) (std::cos(angle) * 40.0f), 64,
                         64));
