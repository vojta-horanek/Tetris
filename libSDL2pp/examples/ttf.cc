...
int main(int, char *[]) try {
    ...
    SDLTTF ttf;
    Window window("libSDL2pp demo: font", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 640, 480,
    ...
    textures.emplace_back(render,
                          font.RenderText_Shaded("Hello, world! (shaded mode)", SDL_Color{255, 255, 255, 255},
    ...
    textures.emplace_back(render,
                          font.RenderUTF8_Blended(u8"Hello, world! «¼½¾» (UTF-8 support)",
                                                  SDL_Color{255, 255, 255, 255})
    );
    textures.emplace_back(render,
                          font.RenderUNICODE_Blended(u"Hello, world! «¼½¾» (UTF-16 support)",
                                                     SDL_Color{255, 255, 255, 255})
    );
